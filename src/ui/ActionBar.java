...
//		sellTower, upgradeTower; 
	...
	private void drawTowerCost(Graphics g) {
		...
		{
			g.setColor(Color.white);
			g.fillRect(205, 710, 120, 50);
			g.setColor(Color.black);
			g.drawRect(205, 710, 120, 50);
			g.setColor(Color.RED);
			g.drawString("Can't Afford", 220, 740);
		...
		else 
		{
			...
			g.drawString("" + getTowerCostName(), 220,730);
			g.drawString("Cost: " + getTowerCostCost() + "g", 250, 750);
		}
